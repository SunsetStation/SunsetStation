/datum/species/ipc
	...
	species_traits = list(NOBLOOD, NOZOMBIE, NOPAIN, NO_BONES, NOTRANSSTING, MUTCOLORS, REVIVESBYHEALING, NOSCAN, NOCHANGELING, NOHUSK, ROBOTIC_LIMBS, NOMOUTH, NOTOX)
	inherent_traits =  list(TRAIT_NOBREATH,TRAIT_RADIMMUNE,TRAIT_VIRUSIMMUNE,TRAIT_EASYDISMEMBER,TRAIT_LIMBATTACHMENT)
