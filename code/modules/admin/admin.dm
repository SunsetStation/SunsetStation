...
/datum/admins/proc/show_player_panel(mob/M in GLOB.mob_list)
	...
	if(M.client)
		...
		body += "<A href='?_src_=holder;[HrefToken()];mute=[M.ckey];mute_type=[MUTE_MENTORHELP]'><font color='[(muted & MUTE_MENTORHELP)?"red":"blue"]'>MENTORHELP</font></a> | " // sunset -- adds mute mentorhelp
