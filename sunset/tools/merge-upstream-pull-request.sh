...
readonly BASE_PULL_URL="https://api.github.com/repos/SunsetStation/SunsetStation/pulls"
...
if ! git remote | grep SunsetStation > /dev/null; then
   git remote add SunsetStation https://github.com/SunsetStation/SunsetStation.git
fi
