...
/datum/antagonist/shadowling/greet()
	...
	to_chat(owner, "<b>If you are new to shadowling, or want to read about abilities, check the wiki page at https://wiki.sunsetstation13.com/index.php?title=Shadowling</b><br>")
	to_chat(owner, "<b>You require [SSticker.mode.required_thralls || 15] thralls to ascend.</b><br>")
	SEND_SOUND(owner.current, sound('sunset/sound/ambience/antag/sling.ogg'))
