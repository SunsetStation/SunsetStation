...
/datum/job/blueshield
	...
	access = list(ACCESS_SECURITY,ACCESS_MEDICAL,ACCESS_MORGUE,ACCESS_ENGINE,ACCESS_MAINT_TUNNELS,ACCESS_TELEPORTER,ACCESS_EVA,ACCESS_HEADS,
			ACCESS_ALL_PERSONAL_LOCKER,ACCESS_COURT,ACCESS_RESEARCH,ACCESS_CONSTRUCTION,ACCESS_CARGO,ACCESS_SEC_DOORS,ACCESS_WEAPONS,
			ACCESS_RC_ANNOUNCE,ACCESS_KEYCARD_AUTH,ACCESS_BLUESHIELD)
	minimal_access = list(ACCESS_SEC_DOORS, ACCESS_MEDICAL, ACCESS_CONSTRUCTION, ACCESS_ENGINE, ACCESS_MAINT_TUNNELS,ACCESS_HEADS,
                  ACCESS_RESEARCH, ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_BLUESHIELD,ACCESS_WEAPONS)
