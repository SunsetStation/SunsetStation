...
/obj/machinery/photocopier/faxmachine
	...
	req_one_access = list(ACCESS_LAWYER, ACCESS_HEADS, ACCESS_ARMORY) //, ACCESS_IAA don't know what the value is for IAA
...
/obj/machinery/photocopier/faxmachine/proc/handle_animation()
	...
	playsound(loc, 'sunset/sound/machinery/printer_dotmatrix.ogg', 50, 1)
